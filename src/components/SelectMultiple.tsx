...
export const SelectMultiple: SelectMultipleComponent = (props) => {
...
interface SelectMultipleProps extends Settings {
  isDropdownOpen?: boolean;
  onTagRemove?: (tag: TagItem) => void;
  onToggleDropdown?: (isOpen: boolean) => void;
}

type SelectMultipleComponent = React.FC<SelectMultipleProps>;
